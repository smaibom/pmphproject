...
struct PrivGlobs {
  ...
  PrivGlobs(  const unsigned int& numX,
    ...
    cudaMalloc((void**)&this->dmyDxx, outer * numX * 4 * sizeof(REAL));
    ...
    cudaMalloc((void**)&this->dmyVarX,numX * numY * sizeof(REAL));
    cudaMalloc((void**)&this->dmyVarY,numX * numY * sizeof(REAL));
    ...
    cudaMalloc((void**)&this->dv, outer * numX * numY * sizeof(REAL));
